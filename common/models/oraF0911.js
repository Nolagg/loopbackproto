...
module.exports=function(oraF0911) {
        ...
        oraF0911.remoteMethod('moveData', {
            ...
            accepts: [{arg: "targetAPI", 
                      ...
                      {arg: "chunkSize",
                       description: "The number of rows that will be processed in one transaction (max 1000 rows)", 
                       type: "Number", 
                       required: true,
                      }
                    ],
